...
public class QuestionsView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subname=findViewById(R.id.subject_name_question);
        subname.setText(MyStaticClass.subjectname);
        myrecycle=findViewById(R.id.question_docs_layout);
        documents=new ArrayList<>();
        docs2=new ArrayList<>();

        databaseReference= FirebaseDatabase.getInstance().getReference().child("EXAMPAPER").child("CLASS"+MyStaticClass.currentOnlineStudent.getCLASS()).child(MyStaticClass.subjectname);
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getChildrenCount() == 0) {
                    ...
                    Documents_Adapter student_adapter = new Documents_Adapter(QuestionsView.this,"EXAMPAPER", docs2);
                    myrecycle.setAdapter(student_adapter);
                    myrecycle.setLayoutManager(new LinearLayoutManager(QuestionsView.this));
                }
            }
