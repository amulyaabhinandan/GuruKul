...
public class HomeworkView extends AppCompatActivity {
    TextView subname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subname=findViewById(R.id.subject_name_homework);
        subname.setText(MyStaticClass.subjectname);
        myrecycle=findViewById(R.id.homework_docs_layout);
        documents=new ArrayList<>();
        docs2=new ArrayList<>();

        databaseReference= FirebaseDatabase.getInstance().getReference().child("HOMEWORK").child("CLASS"+MyStaticClass.currentOnlineStudent.getCLASS()).child(MyStaticClass.subjectname);
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getChildrenCount() == 0) {
                    ...
                    Documents_Adapter student_adapter = new Documents_Adapter(HomeworkView.this,"HOMEWORK", docs2);
                    myrecycle.setAdapter(student_adapter);
                    myrecycle.setLayoutManager(new LinearLayoutManager(HomeworkView.this));
                }
            }
